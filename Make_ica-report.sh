...
ScriptFolder="/mnt/user/yamashita/bin/ICAFIX_labeling_support"
...
while read Subject; do
	...
	echo "${Subject}_ICAFIX.sh" >>${job_dir}/my_task_list
	for Condition in ${CondList}; do
		...
		mkdir -p ${OutFolder}
		echo "#!/bin/sh" >${job_dir}/${Subject}_${Condition}_ICAFIX.sh
		echo "export PATH=/home/yamashita/anaconda3/bin:\$PATH" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
		echo "source activate py27" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
		echo "sed -e 's/KUHP001a/${Subject}/g' ${template_file} > ${DataFolder}/${Subject}_${Condition}.scene" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
		echo "sed -i -e 's/fmriconcat/${Condition}/g' ${DataFolder}/${Subject}_${Condition}.scene" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
		echo "for ica in {1..${ICADIM}};do" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
		...
		echo "done" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
		echo "python ${ScriptFolder}/ica-report --labelfilename fix4melview_HCP_hp2000_thr10.txt ${DataFolder}/${Condition}_hp2000.ica \\" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
        echo "--html-out ${DataFolder}/qc_icafix.html --csvreport ${DataFolder}/icafix.csv --copy-qcdir ${qc_fix_dir}/${Subject}_${Condition}" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
        echo "mkdir -p ${qc_fix_dir}/${Subject}_${Condition}/filtered_func_data.ica/report" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
        echo "cp ${DataFolder}/${Condition}_hp2000.ica/fix4melview_HCP_hp2000_thr10_labels_report.html ${qc_fix_dir}/${Subject}_${Condition}/fix4melview_HCP_hp2000_thr10_labels_report.html" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
        echo "cp ${DataFolder}/${Condition}_hp2000.ica/fix4melview_HCP_hp2000_thr10.txt ${qc_fix_dir}/${Subject}_${Condition}/fix4melview_HCP_hp2000_thr10.txt" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
        echo "cp ${DataFolder}/${Condition}_hp2000.ica/filtered_func_data.ica/report/*.gif ${qc_fix_dir}/${Subject}_${Condition}/filtered_func_data.ica/report/" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
        echo "" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
        echo "chmod -R a+rwx ${qc_fix_dir}/${Subject}_${Condition}/" >>${job_dir}/${Subject}_${Condition}_ICAFIX.sh
		echo "${Subject}_${Condition}_ICAFIX.sh" >>${job_dir}/my_task_list
done
done <<END
$Subjlist
END
